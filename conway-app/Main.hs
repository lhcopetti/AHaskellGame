...
main :: IO ()
main = undefined -- Temporarily disabled
...
-- createObjects :: GameEnvironment -> PhysicsWorld -> MaybeT IO (ConwayWorld, [GameObject GoVoidState])
...
-- mkConwayCell :: Position -> MaybeT IO (GameObject GoVoidState)
